...
private:
    ...
    static Client*& _net() {
        static Client* p = nullptr;
        return p;
    }

    static PubSubClient& _ps() {
    ...
    static QueueHandle_t& _txQ() {
        static QueueHandle_t q = nullptr;
        return q;
    }

    static QueueHandle_t& _txFreeQ() {
        static QueueHandle_t q = nullptr;
        return q;
    }

    static QueueHandle_t& _rxQ() {
        static QueueHandle_t q = nullptr;
        return q;
    }

    static QueueHandle_t& _rxFreeQ() {
        static QueueHandle_t q = nullptr;
        return q;
    }
    ...
    static TickType_t& _backoff() {
        static TickType_t b = pdMS_TO_TICKS(500);
        return b;
    }
